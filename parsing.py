...
def load_all_csvs():
    csv_files = glob.glob("C:\\Users\\matti\\codingProjects\\FantacalcioPythonAnalysis\\fanta-app\\meanSkill*.csv")
...
df2 = pd.read_excel("C:\\Users\\matti\\Downloads\\Quotazioni_Fantacalcio_Stagione_2024_25.xlsx", skiprows=1)
...
df.to_csv("C:\\Users\\matti\\codingProjects\\FantacalcioPythonAnalysis\\fanta-app\\dati_uniti.csv", index=False)
